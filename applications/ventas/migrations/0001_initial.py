    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_invoice', models.CharField(choices=[('0', 'Boleta'), ('1', 'Factura'), ('2', 'Sin comprobante')], max_length=2, verbose_name='TIPO')),
                ('type_payment', models.CharField(choices=[('0', 'Tarjeta'), ('1', 'Efectivo'), ('2', 'Bono'), ('3', 'Otro')], max_length=2, verbose_name='TIPO PAGO')),
