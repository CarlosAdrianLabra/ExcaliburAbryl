    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_invoice', models.CharField(choices=[('2', 'Sin Factura'), ('1', 'Factura')], max_length=2, verbose_name='TIPO')),
                ('type_payment', models.CharField(choices=[('1', 'Efectivo'), ('0', 'Tarjeta')], max_length=2, verbose_name='TIPO PAGO')),
                ('close', models.BooleanField(default=False, verbose_name='Venta Anulada')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('producto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_sale', to='inventarios.productos', verbose_name='producto')),
                ('sale', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='detail_sale', to='ventas.venta', verbose_name='Codigo de Venta')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('count', models.PositiveIntegerField(verbose_name='Cantidad')),
                ('producto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_car', to='inventarios.productos', verbose_name='producto')),
            ],
            options={
